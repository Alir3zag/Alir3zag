...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>
        CLI that scores GitHub repository health 0–100 across commit momentum,
        HHI bus factor, issue resolution, PR latency, and release cadence.
        Async API client, risk flag detection, AI narrative summary.
      </p>
      <p>
    ...
    <td width="50%" valign="top">
      ...
      <p>
        ...
        Amazon, and eBay. JWT auth, per-user APScheduler automation,
        weighted deal scoring (A–D), email alerts, PostgreSQL.
      </p>
      <p>
